...
const Cards = (props) => {
    ...
    // console.log(props);
    return (
        <div className="col-md-4 g-4 hvr-sweep-to-bottom ">
      ...
      <div className="card-body ">
        ...
        <p ><small className="text-dark">Country: {contry}</small></p>
               <button
                ...
                className="btn btn-warning text-center text-white button-size hvr-grow"><i className="fas fa-rocket"></i> Hired Me</button>
         <br />
